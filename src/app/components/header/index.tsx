        ...
        return <div className={styles.wrapper}>
            ...
            <div className={styles.mobileBanner}>
              <div className={styles.left}>
                ...
                animate={ !menuState ? { width: 0, opacity: 0} : { width: "45vw", opacity: 1 } } 
                transition={{ duration: 0.75, ease: "easeInOut", }}
                >
      ...
      <div className={styles.base}></div>
        ...
        { isSticky && 
          <div className={styles.hoverMenuContainer}>
            <motion.div className={styles.hoverMenu}
            onHoverStart={() => setMenuHovered(true)}
            onHoverEnd={() => setMenuHovered(false)}
            >
              Menu
        ...
        <div aria-hidden style={divProperties}>
          {text.split('').map((c, i) => (
            <motion.span key={`${c}-${i}`}
              ...
              transition={{ delay: delay * i, ease: "easeInOut", duration: duration, }}
            >
              {c}
            </motion.span>
          ))}
