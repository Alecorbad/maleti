...
const galleriesMapPath = path.join(
  process.cwd(),
  "src",
  "json",
  "galleries.json",
...
function galleryFactory(
  galleriesPath: string,
  title: string,
  galleryFolder: GalleryFolderName,
  galleryPage: GalleryPage,
): Gallery {
  const folderPath = `${galleriesPath}${galleryFolder}`;
  const parsedJsonGallery: Gallery | undefined = jsonParsedGalleries.find(
    (g) => g.id == galleryFolder,
  );
  const paintings: Painting[] =
    getPaintings(folderPath, parsedJsonGallery) ?? [];
...
export function getGallery(searchData: string): Gallery {
  ...
  if (
    searchData == GalleryFolderName.FrammentiInconscio ||
    searchData == GalleryPage.FrammentiInconscio
  ) {
    return galleryFactory(
      baseGalleryPath,
      "Frammenti d'Inconscio",
      GalleryFolderName.FrammentiInconscio,
      GalleryPage.FrammentiInconscio,
    );
  }

  if (
    searchData == GalleryFolderName.FormeArchetipiche ||
    searchData == GalleryPage.FormeArchetipiche
  ) {
    return galleryFactory(
      baseGalleryPath,
      "Forme Archetipiche",
      GalleryFolderName.FormeArchetipiche,
      GalleryPage.FormeArchetipiche,
    );
  }

  if (
    searchData == GalleryFolderName.Cartoni ||
    searchData == GalleryPage.Cartoni
  ) {
    return galleryFactory(
      baseGalleryPath,
      "Cartoni",
  ...
  if (
    searchData == GalleryFolderName.LettereNuovoMondo ||
    searchData == GalleryPage.LettereNuovoMondo
  ) {
    return galleryFactory(
      baseGalleryPath,
      "Lettere dal Nuovo Mondo",
      GalleryFolderName.LettereNuovoMondo,
      GalleryPage.LettereNuovoMondo,
    );
  }

  if (
    searchData == GalleryFolderName.AgiliFragili ||
    searchData == GalleryPage.AgiliFragili
  ) {
    return galleryFactory(
      baseGalleryPath,
      "Agili Fragili",
      GalleryFolderName.AgiliFragili,
      GalleryPage.AgiliFragili,
    );
  }

  if (
    searchData == GalleryFolderName.Floras ||
    searchData == GalleryPage.Floras
  ) {
    return galleryFactory(
      baseGalleryPath,
      "Floras",
  ...
  if (
    searchData == GalleryFolderName.Ikebana ||
    searchData == GalleryPage.Ikebana
  ) {
    return galleryFactory(
      baseGalleryPath,
      "Ikebana",
  ...
  if (
    searchData == GalleryFolderName.Frammenti ||
    searchData == GalleryPage.Frammenti
  ) {
    return galleryFactory(
      baseGalleryPath,
      "Frammenti",
      GalleryFolderName.Frammenti,
      GalleryPage.Frammenti,
    );
  }

  if (
    searchData == GalleryFolderName.Butterfly ||
    searchData == GalleryPage.Butterfly
  ) {
    return galleryFactory(
      baseGalleryPath,
      "Butterfly",
      GalleryFolderName.Butterfly,
      GalleryPage.Butterfly,
    );
  }

  if (
    searchData == GalleryFolderName.Croste ||
    searchData == GalleryPage.Croste
  ) {
    return galleryFactory(
      baseGalleryPath,
      "Croste",
  ...
  if (
    searchData == GalleryFolderName.DiecimilaMondi ||
    searchData == GalleryPage.DiecimilaMondi
  ) {
    return galleryFactory(
      baseGalleryPath,
      "Diecimila Mondi",
      GalleryFolderName.DiecimilaMondi,
      GalleryPage.DiecimilaMondi,
    );
  }

  if (
    searchData == GalleryFolderName.EsiliSegni ||
    searchData == GalleryPage.EsiliSegni
  ) {
    return galleryFactory(
      baseGalleryPath,
      "Esili Segni",
      GalleryFolderName.EsiliSegni,
      GalleryPage.EsiliSegni,
    );
  }

  if (
    searchData == GalleryFolderName.GiardinoImpermanenza ||
    searchData == GalleryPage.GiardinoImpermanenza
  ) {
    return galleryFactory(
      baseGalleryPath,
      "Il Giardino dell'Impermanenza",
      GalleryFolderName.GiardinoImpermanenza,
      GalleryPage.GiardinoImpermanenza,
    );
  }

  if (
    searchData == GalleryFolderName.Matite ||
    searchData == GalleryPage.Matite
  ) {
    return galleryFactory(
      baseGalleryPath,
      "Matite",
  ...
  if (
    searchData == GalleryFolderName.Squosh ||
    searchData == GalleryPage.Squosh
  ) {
    return galleryFactory(
      baseGalleryPath,
      "Squosh",
  ...
  if (
    searchData == GalleryFolderName.Torri ||
    searchData == GalleryPage.Torri
  ) {
    return galleryFactory(
      baseGalleryPath,
      "Torri",
  ...
  if (
    searchData == GalleryFolderName.IncontriDeserto ||
    searchData == GalleryPage.IncontriDeserto
  ) {
    return galleryFactory(
      baseGalleryPath,
      "Incontri nel Deserto",
      GalleryFolderName.IncontriDeserto,
      GalleryPage.IncontriDeserto,
    );
  }

  if (
    searchData == GalleryFolderName.TorriPreziose ||
    searchData == GalleryPage.TorriPreziose
  ) {
    return galleryFactory(
      baseGalleryPath,
      "Torri Preziose",
      GalleryFolderName.TorriPreziose,
      GalleryPage.TorriPreziose,
    );
  }
